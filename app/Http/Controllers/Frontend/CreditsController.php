...
class CreditsController extends Controller
{
    public function index()
    {
        ...
        $credits = Credit::with(['service_request', 'user'])->where('user_id', Auth::user()->id)->first();
    ...
    public function create()
    {
        ...
        return view('frontend.credits.create', compact('service_requests', 'users'));
    }
    ...
    public function edit(Credit $credit)
    {
        ...
        return view('frontend.credits.edit', compact('credit', 'service_requests', 'users'));
    }
