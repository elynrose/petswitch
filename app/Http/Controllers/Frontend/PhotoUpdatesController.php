...
class PhotoUpdatesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.photoUpdates.index', compact('photoUpdates'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.photoUpdates.create', compact('bookings', 'users'));
    }
    ...
    public function store(StorePhotoUpdateRequest $request)
    {
        ...
        return redirect()->route('frontend.photo-updates.index');
    }
    ...
    public function edit(PhotoUpdate $photoUpdate)
    {
        ...
        return view('frontend.photoUpdates.edit', compact('bookings', 'photoUpdate', 'users'));
    }
    ...
    public function show(PhotoUpdate $photoUpdate)
    {
        ...
        return view('frontend.photoUpdates.show', compact('photoUpdate'));
    }
