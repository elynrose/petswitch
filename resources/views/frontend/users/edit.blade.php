                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="zip" id="zip" value="{{ old('zip', $user->zip) }}">
                            @if($errors->has('zip'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('zip') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="conscent" id="conscent" value="1" {{ $user->conscent || old('conscent', 0) === 1 ? 'checked' : '' }}>
                                <label for="conscent">{{ trans('cruds.user.fields.conscent') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="email_notification" id="email_notification" value="1" {{ $user->email_notification || old('email_notification', 0) === 1 ? 'checked' : '' }}>
                                <label for="email_notification">{{ trans('cruds.user.fields.email_notification') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="sms_notification" id="sms_notification" value="1" {{ $user->sms_notification || old('sms_notification', 0) === 1 ? 'checked' : '' }}>
                                <label for="sms_notification">{{ trans('cruds.user.fields.sms_notification') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="banned" id="banned" value="{{ old('banned', $user->banned) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="expiry" id="expiry" value="{{ old('expiry', $user->expiry) }}">
