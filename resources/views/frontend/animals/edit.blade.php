    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.animals.update", [$animal->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="animal">{{ trans('cruds.animal.fields.animal') }}</label>
                            <input class="form-control" type="text" name="animal" id="animal" value="{{ old('animal', $animal->animal) }}">
