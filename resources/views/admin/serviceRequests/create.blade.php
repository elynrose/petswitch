    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.service-requests.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip_code') ? 'is-invalid' : '' }}" type="number" name="zip_code" id="zip_code" value="{{ old('zip_code', '') }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pending') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pending" id="pending" value="1" {{ old('pending', 0) == 1 ? 'checked' : '' }}>
