                ...
                <tbody>
                    @foreach($bookings as $key => $booking)
                        <tr data-entry-id="{{ $booking->id }}">
                            ...
                            <td>
                                {{ $booking->service_request->zip_code ?? '' }}
                            </td>
                            <td>
                                {{ $booking->service_request->to ?? '' }}
                            </td>
                            <td>
                                <span style="display:none">{{ $booking->service_request->closed ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $booking->service_request->closed ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $booking->decline ?? '' }}</span>
