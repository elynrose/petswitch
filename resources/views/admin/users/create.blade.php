        ...
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('conscent') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="conscent" id="conscent" value="1" {{ old('conscent', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('email_notification') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="email_notification" id="email_notification" value="1" {{ old('email_notification', 0) == 1 || old('email_notification') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sms_notification') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sms_notification" id="sms_notification" value="1" {{ old('sms_notification', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banned') ? 'is-invalid' : '' }}" type="number" name="banned" id="banned" value="{{ old('banned', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expiry') ? 'is-invalid' : '' }}" type="text" name="expiry" id="expiry" value="{{ old('expiry') }}">
