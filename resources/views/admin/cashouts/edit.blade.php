...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.cashouts.update", [$cashout->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credits') ? 'is-invalid' : '' }}" type="number" name="credits" id="credits" value="{{ old('credits', $cashout->credits) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $cashout->amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('issued') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="issued" id="issued" value="1" {{ $cashout->issued || old('issued', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tracking') ? 'is-invalid' : '' }}" type="text" name="tracking" id="tracking" value="{{ old('tracking', $cashout->tracking) }}">
